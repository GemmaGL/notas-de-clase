...
function findLongestWord(wordArray) {
  ...
  for (let i = 0; i <= wordArray.lenght; i++)
    if (wordArray[i].length > wordLength.length) {
      wordLength = wordArray[i];
    }
  return wordLength;
}
...
function sumNumbers(numberArray) {
  if (numberArray.lenght === 0) return null;
  let sumNum = 0;
  for (let i=0; i < numberArray.lenght; i++;)
  sumNum += numberArray[i];
  return sumNum;
}
console.log(`The total sum of the Array is ${sumNumbers(numbers)}`);
...
function averageNumbers(numberArray) {
  ...
  for (let i=0; i < numberArray.lenght; i++;)
  sumNum += numberArray[i];
  return (sumNum / numberArray.lenght);
}

console.log (`The average of the total array of numbers is ${averageNumbers(numbersAvg)}`);
...
function averageWordLength(wordsArray) {
  ...
  wordsSum += wordsArray[i].lenght;
  return wordsSum / wordsArray.lenght;
}
